    ...
    <>
      ...
      <main className="relative z-[2] flex flex-1 flex-col items-center justify-center gap-7 px-8 pt-16 pb-24 max-sm:gap-6 max-sm:px-6 max-sm:pt-10 max-sm:pb-16">
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          <p className="max-w-md text-[clamp(1rem,1.45vw,1.12rem)] leading-relaxed font-light tracking-[0.005em] text-white/60">
            For client work, collaborations, or just to say hi:
          </p>
          <div className="flex flex-col items-center gap-4">
            <a
              href="mailto:contact@purpl.au?subject=Hi"
              className="text-[clamp(1rem,2vw,1.35rem)] font-light tracking-[0.04em] text-white/60 underline decoration-white/20 underline-offset-8 transition-[color,text-decoration-color] hover:text-white hover:decoration-white/60"
            >
              contact@purpl.au
            </a>
            <a
