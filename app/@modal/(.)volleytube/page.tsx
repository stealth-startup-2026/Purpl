...
// Soft-navigation intercept for /volleytube. Renders the project modal inside the
// @modal slot when the user clicks the project's card on /work. Direct
// visits to /volleytube (reload, deep link) bypass this and hit app/[project]/page.tsx.
